...
# --- Initialization ---
clear
echo -e "${GREEN}=== Telemt Custom Distroless Builder (telemt3dm) ===${NC}"
...
# --- Menu ---
echo -e "\nSelect Action:"
echo -e " 1) ${CYAN}Install${NC}           (Build from source)"
...
case $CHOICE in
    1)
        ...
        rm -rf "$REPO_DIR"
        git clone --depth 1 https://github.com/telemt/telemt.git "$REPO_DIR"
        cd "$REPO_DIR" || exit 1
