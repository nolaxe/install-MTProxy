...
> вариант 1 - Установка из готового образа ~5мб `https://hub.docker.com/r/whn0thacked/telemt-docker` 
#### Cкрипт для развертывания TeleMT  
...
- результат  
<img width="563" height="74" alt="image" src="https://github.com/user-attachments/assets/01df349f-7dc9-4299-81d5-0cb7469e2779" />
